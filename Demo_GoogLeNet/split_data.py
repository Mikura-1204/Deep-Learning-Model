...
def main():
    ...
    # ciallo: 两级目录 最后是 ./flower_data/flower_photos 因为要在原数据路径下分训练测试集
    # ciallo: When use, change this dir to yours.
    ...
    # ciallo: return all the classes into a list. File name is class
    data_class = [cla for cla in os.listdir(origin_flower_path)
    ...
    print("Finish Processing ! Ciallo(∠・ω< )⌒☆")
